    ...
    <div class="col-md-12">
        <div class="card" style="border-radius: 15px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
            <div class="card-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 15px 15px 0 0;">
                <h5 class="mb-0">📊 Ringkasan Data Pengungkapan Saat Ini</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="p-3" style="background: #f8f9fa; border-radius: 10px;">
                            ...
                            <h3 class="mb-0 text-primary"><?php echo number_format($current_data['jumlah_laporan']); ?></h3>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="p-3" style="background: #f8f9fa; border-radius: 10px;">
                            <h6 class="text-muted mb-2">Tersangka Penyidikan</h6>
                            <h3 class="mb-0 text-warning"><?php echo number_format($current_data['tersangka_penyidikan']); ?></h3>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="p-3" style="background: #f8f9fa; border-radius: 10px;">
                            <h6 class="text-muted mb-2">Tersangka Rehabilitasi</h6>
                            <h3 class="mb-0 text-success"><?php echo number_format($current_data['tersangka_rehabilitasi']); ?></h3>
                        </div>
                    </div>
                </div>
                <hr>
                <h6 class="mb-3">💊 Total Barang Bukti:</h6>
                <div class="row">
                    <div class="col-md-3 col-sm-6 mb-2">
                        <strong>Sabu:</strong> <?php echo number_format($current_data['bb_sabu'], 2); ?> gram
                    </div>
                    <div class="col-md-3 col-sm-6 mb-2">
                        <strong>Ganja:</strong> <?php echo number_format($current_data['bb_ganja'], 3); ?> kg
                    </div>
                    <div class="col-md-3 col-sm-6 mb-2">
                        <strong>Ekstasi:</strong> <?php echo number_format($current_data['bb_ekstasi'], 0); ?> butir
                    </div>
                    <div class="col-md-3 col-sm-6 mb-2">
                        <strong>Happy Five:</strong> <?php echo number_format($current_data['bb_happy_five']); ?> butir
                    </div>
                </div>
            </div>
        </div>
