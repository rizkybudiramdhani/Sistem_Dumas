...
<div class="row pb-10">
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
        <div class="card card-stats">
            <div class="card-body text-center py-4">
                <div class="stats-icon mx-auto mb-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
        <div class="card card-stats">
            <div class="card-body text-center py-4">
                <div class="stats-icon mx-auto mb-3" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                    <i class="icon-copy dw dw-inbox"></i>
                </div>
                <h3 class="mb-0"><?php echo $baru; ?></h3>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
        <div class="card card-stats">
            <div class="card-body text-center py-4">
                <div class="stats-icon mx-auto mb-3" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                    <i class="icon-copy dw dw-loading"></i>
                </div>
                <h3 class="mb-0"><?php echo $diproses; ?></h3>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
        <div class="card card-stats">
            <div class="card-body text-center py-4">
                <div class="stats-icon mx-auto mb-3" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);">
                    <i class="icon-copy dw dw-checked"></i>
                </div>
                <h3 class="mb-0"><?php echo $selesai; ?></h3>
...
<div class="card table-card mb-30">
    <div class="card-header">
        <h4 class="mb-0">📋 Daftar Pengaduan Masyarakat</h4>
    </div>
    <div class="card-body">
