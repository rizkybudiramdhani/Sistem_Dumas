    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-4 text-right">
            <div style="background: rgba(255,255,255,0.2); padding: 15px; border-radius: 10px; display: inline-block;">
                <div style="font-size: 0.9rem; opacity: 0.9;">Laporan Hari Ini</div>
                <div style="font-size: 2.5rem; font-weight: 700;"><?php echo $total_today; ?></div>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
        ...
        <div class="card chart-card">
            <div class="card-body pd-20">
                <div class="d-flex flex-wrap justify-content-between align-items-center pb-3">
                    <div>
                        <h5 class="text-blue mb-0">📊 Grafik Laporan Per Bulan</h5>
                        <p class="mb-0 text-muted small">Statistik 6 bulan terakhir</p>
                    </div>
                    <div class="form-group mb-0">
                        <select class="form-control form-control-sm" style="border-radius: 10px;">
    ...
    <div class="col-xl-4 col-lg-4 col-md-12 mb-20">
        ...
        <!-- Total Pengguna Card -->
        <div class="card mb-20" style="border-radius: 15px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1); border: none;">
            <div class="card-body text-center pd-20">
                <div class="widget-icon mx-auto mb-3" style="width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: #667eea;">
                    <i class="icon-copy dw dw-user1" style="font-size: 40px; color: white;"></i>
                </div>
                <h2 class="weight-700 mb-2" style="color: white; font-size: 3rem;"><?php echo $total_users; ?></h2>
                <p class="font-16 text-secondary mb-3">Total Masyarakat Terdaftar</p>

                <?php if ($stats): ?>
                    <div class="row text-center pt-2">
                        <div class="col-6">
                            <div style="background: #e7f7ef; padding: 15px; border-radius: 10px;">
                                <div class="font-24 weight-700 text-success">
                                    <?php echo $stats['jumlah_penangkapan']; ?>
                                </div>
                                <div class="font-12 text-secondary">Penangkapan</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div style="background: #e7f0ff; padding: 15px; border-radius: 10px;">
                                <div class="font-24 weight-700 text-primary">
                                    <?php echo $stats['jumlah_tim']; ?>
                                </div>
                                <div class="font-12 text-secondary">Tim Aktif</div>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
