        ...
        <div class="row">
            ...
            ?>
                <div class="col-md-4 mb-3">
                    <div class="card h-100" style="border: 1px solid #e9ecef; border-radius: 10px;">
                        ...
                        <?php endif; ?>
                        <div class="card-body">
                            <h6 class="card-title"><?php echo htmlspecialchars(substr($row['judul_berita'], 0, 60)); ?>...</h6>
            ...
            ?>
                <div class="col-12 text-center py-5 text-muted">
                    <i class="icon-copy dw dw-newspaper" style="font-size: 3rem; opacity: 0.3;"></i>
                    <p class="mb-0 mt-2">Belum ada berita</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<script>
    ...
    document.getElementById('form-berita').addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<i class="icon-copy dw dw-loading"></i> Mempublikasikan...';
